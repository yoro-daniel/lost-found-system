...
('LST-2026-0001', 2, 1, 3, 'lost', 'Wireless Earbuds Case', 'White earbuds charging case, no earbuds inside.', '2026-05-07', NULL, 'user@lostfound.test', '09170000002', 'open'),
...
VALUES (1, 2, 'Maria Santos', 'maria@student.test', '09170000003', 'Can provide matching registration card and student number.', 'pending');

INSERT INTO activity_logs (user_id, action, description) VALUES
(1, 'seed', 'Initial database records were loaded.'),
(2, 'claim_created', 'Submitted a sample claim request.');
